...
-- depends_on: {{ source('line3_huaxuanmes3', '_airbyte_raw_warehousechu') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['Warehouse1ID'], ['Warehouse1ID']) }} as warehouse1id,
...
from {{ source('line3_huaxuanmes3', '_airbyte_raw_warehousechu') }} as table_alias
-- warehousechu
where 1 = 1
