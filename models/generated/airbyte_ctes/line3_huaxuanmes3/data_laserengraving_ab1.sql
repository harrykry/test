...
-- depends_on: {{ source('line3_huaxuanmes3', '_airbyte_raw_data_laserengraving') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['LaserEngravingCode'], ['LaserEngravingCode']) }} as laserengravingcode,
...
from {{ source('line3_huaxuanmes3', '_airbyte_raw_data_laserengraving') }} as table_alias
-- data_laserengraving
where 1 = 1
