...
-- depends_on: {{ source('line3_huaxuanmes3', '_airbyte_raw_setting_packagenum') }}
select
    {{ json_extract_scalar('_airbyte_data', ['SettingNum'], ['SettingNum']) }} as settingnum,
...
from {{ source('line3_huaxuanmes3', '_airbyte_raw_setting_packagenum') }} as table_alias
-- setting_packagenum
where 1 = 1
