...
-- depends_on: {{ source('line3_huaxuanmes3', '_airbyte_raw_data_card') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['Station6'], ['Station6']) }} as station6,
    {{ json_extract_scalar('_airbyte_data', ['Code'], ['Code']) }} as {{ adapter.quote('Code') }},
    {{ json_extract_scalar('_airbyte_data', ['Station4'], ['Station4']) }} as station4,
    {{ json_extract_scalar('_airbyte_data', ['Station5'], ['Station5']) }} as station5,
    {{ json_extract_scalar('_airbyte_data', ['Station2'], ['Station2']) }} as station2,
    {{ json_extract_scalar('_airbyte_data', ['Station3'], ['Station3']) }} as station3,
    {{ json_extract_scalar('_airbyte_data', ['Station1'], ['Station1']) }} as station1,
...
from {{ source('line3_huaxuanmes3', '_airbyte_raw_data_card') }} as table_alias
-- data_card
where 1 = 1
